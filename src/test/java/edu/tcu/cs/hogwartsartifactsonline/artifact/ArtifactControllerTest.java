...
class ArtifactControllerTest {
    ...
    @Value("${api.endpoint.base-url}") // to go to application.yml to find the value & inject into this field.
    String baseUrl;
    ...
    @Test
    void testFindArticleByIdSuccess() throws Exception {
        // Given
        given(this.artifactService.findById("1250808601744904191")).willReturn(this.artifacts.get(0));

        // When and then //create fake http get request
