...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .anyRequest().authenticated() // good idea to put this as last.
                )
                ...
                /* Configures the spring boot application as an OAuth2 Resource Server that authenticates all
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(12); //2^12 rounds of hashing
    }
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        /*
        say that the authorization server communicates authorities in a custom claim called "authorities".
        In that case, then configure the claim that JwtAuthenticationConverter should inspect, like so:
         */
        jwtGrantedAuthoritiesConverter.setAuthoritiesClaimName("authorities");
        /*
        You can also configure the authority prefix to be different as well. The default prefix is "SCOPE_".
